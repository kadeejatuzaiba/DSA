...
//^ 1. Implement a Queue using an Array and handle circular wrapping.
// 2. Implement a Queue using a Linked List.
// 3. Implement a Queue using two Stacks. *(LeetCode #232)*
// 4. Implement a Stack using two Queues.
// 5. Reverse a queue.
// 6. Implement a Circular Queue with a fixed capacity.
// 7. Implement a Double-Ended Queue (Deque).
// 8. Generate Binary Numbers from 1 to N using a queue.